...
def draw_boxes(pts,img, bbox, identities=None, offset=(0, 0)):
...
def detect(opt, save_img=False):
    ...
    for frame_idx, (path, img, im0s, vid_cap) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            save_path1 = str(Path('inference/output') / Path(p).name)
            ...
            if save_img:
                ...
                if dataset.mode == 'images':
                    ...
                    print('saving video!')
                    if vid_path != save_path1:  # new video
                        vid_path = save_path1
                        ...
                        vid_writer = cv2.VideoWriter(
                            save_path1, cv2.VideoWriter_fourcc(*opt.fourcc), fps, (w, h))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                default='yolov5/Yolov5_Weights_Video/ATCC_yolov5_best.pt',help='model.pt path')  #    default='yolov5/yolov5m_results2/weights/best.pt', help='model.pt path')
    # file/folder, 0 for webcam
    parser.add_argument('--source', type=str,
                        default='TestVideo.mp4', help='source')  #default='traffic2.mp4', help='source')
    parser.add_argument('--output', type=str,  default='ESRGAN/LR', # default='inference/output',  ESRGAN/LR/
